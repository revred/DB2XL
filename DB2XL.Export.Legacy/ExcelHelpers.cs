...
internal static class ExcelHelpers
{
    ...
    internal static (IXLWorksheet Worksheet, DataChecksumCalculator DataChecksumCalculator) NewSheet(
        XLWorkbook workbook, 
        ...
        HashSet<string>? usedNames = null)
    {
        ...
        var checksumBuilder = new DataChecksumCalculator();
    ...
    internal static (IXLWorksheet Worksheet, DataChecksumCalculator DataChecksumCalculator) NewSheetWithSuffix(
        XLWorkbook workbook, 
        string baseSheetName, 
        int partNumber, 
        IReadOnlyList<ColumnInfo> columns, 
